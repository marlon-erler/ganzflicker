...
silent only
silent tabonly
cd ~/Documents/Code/Junk/ganzflicker
...
exe 'vert 4resize ' . ((&columns * 78 + 95) / 190)
argglobal
enew
...
wincmd w
argglobal
if bufexists(fnamemodify("styles.css", ":p")) | buffer styles.css | else | edit styles.css | endif
balt index.html
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
wincmd w
argglobal
if bufexists(fnamemodify("script.js", ":p")) | buffer script.js | else | edit script.js | endif
balt index.html
setlocal keymap=
setlocal noarabic
setlocal autoindent
